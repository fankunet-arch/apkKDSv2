...
package com.toptea.topteakds.databinding;
...
public final class ActivityScannerBinding implements ViewBinding {
  ...
  private ActivityScannerBinding(@NonNull FrameLayout rootView, @NonNull PreviewView previewView) {
  ...
  public static ActivityScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScannerBinding((FrameLayout) rootView, previewView);
    }
